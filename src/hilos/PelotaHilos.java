...
public class PelotaHilos implements Runnable {
    ...
    @Override
    public void run() {
        System.out.println("Hilo: " + Thread.currentThread() + "\nEstado de interrupcion del hilo al comenzar: " + Thread.currentThread().isInterrupted());
        ...
        System.out.println("Hilo: " + Thread.currentThread() + "\nEstado de interrupcion del hilo al terminar: " + Thread.currentThread().isInterrupted());
    }
}
